...
variable "container_images" {
  ...
  default = {
    ...
    kube_apiserver            = "k8s.gcr.io/hyperkube:v1.17.3"
    kube_controller_manager   = "k8s.gcr.io/hyperkube:v1.17.3"
    kube_scheduler            = "k8s.gcr.io/hyperkube:v1.17.3"
    kube_proxy                = "k8s.gcr.io/hyperkube:v1.17.3"
    kubelet                   = "k8s.gcr.io/hyperkube:v1.17.3"
